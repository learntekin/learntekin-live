...
export default class Services extends Component {
  ...
  >
    ...
    <p style="color: #555; line-height: 1.6; text-align: justify; margin-bottom: 20px;">
      Transform your ideas into stunning and user-friendly digital experiences
      with our professional UI/UX design services. Our team combines creativity
      with the latest design principles to craft intuitive, accessible, and
      visually engaging interfaces. From wireframes to prototypes, we ensure
      every element aligns with your brand and enhances user satisfaction.
    </p>
    <button
      style="
