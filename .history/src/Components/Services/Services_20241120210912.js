...
export default class Services extends Component {
  ...
  >
    <div style="display: flex; align-items: center; margin-bottom: 15px;">
      ...
      <h2 style="margin: 0; color: #333;">Website Development</h2>
    </div>
    <p style="color: #555; line-height: 1.6; text-align: justify; margin-bottom: 20px;">
      We provide top-notch website development services to our clients. Our
      team of experienced developers uses the latest technologies and
      frameworks to develop websites that are responsive, fast, and secure.
      We can build websites of all types, including e-commerce, corporate,
