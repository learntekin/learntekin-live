...
class FAQSection extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      error: null, // To handle any error that occurs while fetching data
    };
  }
    ...
    getDocs(faqsCollection)
      .then((querySnapshot) => {
        ...
        querySnapshot.forEach((doc) => {
          // Ensure the document has 'question' and 'answer'
          const data = doc.data();
      ...
      .catch((error) => {
        ...
        this.setState({ error: "Failed to fetch FAQs", loading: false });
      });
  }
