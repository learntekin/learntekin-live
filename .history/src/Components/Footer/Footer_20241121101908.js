      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links mt-3">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="/Services">Website Development ( Flask/Djongo MERN | MEAN | Laravel | Web3/DApps)</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="/Services">UI/UX Development & Designing</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="/Services">Android App Development ( Java | Kotlin | Flutter | Python)</a></li>
