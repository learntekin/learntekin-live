              ...
              <div class="content">
                ...
                <p align="justify" style={{ fontSize: "22px", color: "black" }}>
                  ...
                  <p>
                    ...
                    excel in the technology industry. The program is divided
                    into modules, each covering a specific aspect of the
                    technology domain. Learners are expected to complete each
                    module before moving on to the next module. You may have to
                    choose any one module from each module.
                  </p>

                  <p>
                    The <strong className="st-b">Internship</strong> offered by{" "}
                    <strong className="st-b">Learn TEK In</strong> is designed
                    to equip individuals with the necessary skills to excel in
                    the technology industry. This internship will sharpe the
                    skills in the various technologies in the digital world
                  </p>

                  <p>
               
                    The <strong className="st-b">
                      various business services and technical solutions</strong>{" "} offered by <strong className="st-b">Learn TEK In</strong> is
