            ...
            <div class="col-lg-5 col-md-4 m-2 ">
              ...
              >
                ...
                <Button
                  ...
                  onClick={this.handleClick}
                >
                  <Link className="join" to="https://forms.gle/KY7gWBv78dzy3MC48">
                    {" "}
                    Join now
                  </Link>
                </Button>
            ...
            <div class="col-lg-5 col-md-4 m-2">
              ...
              >
                ...
                <Button
                  ...
                  onClick={this.handleClick}
                >
         <a className="join" hre="https://forms.gle/KY7gWBv78dzy3MC48">
                    {" "}
                    Join now
                  </a>
                </Button>
            ...
            <div class="col-lg-5 col-md-4 m-2">
              ...
              >
                ...
                <Button
                  ...
                  onClick={this.handleClick}
                >
      <a className="join" href="https://forms.gle/KY7gWBv78dzy3MC48">
                    {" "}
                    Join now
                  </a>
                </Button>
