          ...
          <div class="row no-gutters">
            <div class="content">
              <p align="justify" style={{ fontSize: "18px", color: "black" }}>
                ...
                <div class="container-fluid">
                  <div class="jumbotron">
                    <h1 class="display-4 m-4">தமிழ்நாட்டின் வெற்றி பயணத்தில் Learn TEK In</h1>
                  </div>
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p style={{ margin: "1rem" }}>
                            ...
                            Learn TEK In தமிழ்நாட்டில் நகர்ப்புறம் மற்றும்
                            கிராமப்புற மக்களுக்கு சமமாக தொழில்நுட்ப திறன்களை
                            கற்றுத் தரும் சிறந்த பயிற்சி மையமாக திகழ்கிறது.
                            React, Flutter, MERN Stack, Spring Boot, DevOps
                            போன்ற நவீன தொழில்நுட்பங்களில் சிறந்த பயிற்சிகளை
                            வழங்கி, பொருத்தமான வேலை வாய்ப்புகளை உருவாக்குவதில்
