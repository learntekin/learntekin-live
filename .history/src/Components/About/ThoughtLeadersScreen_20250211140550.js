...
const charity=[{
  ...
  benefits:"We wanted to reach out about a small but impactful project hashtag #collarthevoiceless we're working on—getting reflective collars for stray dogs to keep them safe at night. ",
