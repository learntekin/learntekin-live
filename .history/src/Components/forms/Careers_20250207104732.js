...
export default class Careers extends Component {
  handleSubmit = async (event) => {
    ...
    const formData = {
      ...
      timestamp: firebase.database.ServerValue.TIMESTAMP, // Adds a timestamp to optimize query performance
    };
    ...
    try {
      ...
      if (error.message.includes("Quota exceeded")) {
        Swal.fire({
          ...
          text: "We have reached our submission limit. Please try again later.",
          icon: "error",
          confirmButtonText: "OK",
        });
      } else {
